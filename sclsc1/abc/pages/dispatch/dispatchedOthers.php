<?php 
	...
	require_once $_SESSION['base_url'].'/classes/Implementation/Dispatcher/Fetch.php';
	...
	$fetchDisp      = new impDispatcher\Fetch();
	...
	$diary = $fetchDisp->getOtherDispApplication($limit, $start);
	$Records = $fetchDisp->getOtherDispApplicationCount();
	$url ='';
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     			<ul>
	     				...
	     				<li><a href="#">Dispatched Other Files</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td><?php echo $diary[$i]['file_head']; ?></td>
				     				<!-- 	<td><?php echo $diary[$i]['pincode']; ?></td> -->
				     					<td><?php echo $diary[$i]['name']; ?></td>
				     					<td><?php echo $diary[$i]['subject']; ?></td>
				     					<td><?php echo $diary[$i]['place']; ?></td>
				     					<td><?php echo $diary[$i]['city']; ?></td>				     				
				     				</tr>
