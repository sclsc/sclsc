<?php 
	...
	if(isset($_GET['page']))
	{
		...
		if($page){
		 ...
		 $alltranslator = $fetchTranslator->getTranslatorOnPannel($limit,$start);
		 $Records = $fetchTranslator->getTranslatorOnPannelCount();
		 $url='';
			...
			<div id="right-wrapper">
				...
				?>
	     		...
	     		<div class="title1" style="height:20px;">
     				<div id="left-title">Translator Appoinment List</div>
	     			...
	     			<div style="border:2px solid #4b8df8;padding:7px;">
		     			<table id="table-records" cellpadding="0px" cellspacing="0px" width="100%">
							...
							?>
	     					...
	     					<td><?php echo $i+1; ?></td>	     					
	     					 <td><a href="view_adv_details.php?translatorId=<?php echo $alltranslator[$i]['id']; ?>" ><?php echo $alltranslator[$i]['translator_name']; ?></a></td>
