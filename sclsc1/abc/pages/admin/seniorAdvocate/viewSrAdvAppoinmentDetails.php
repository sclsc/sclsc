<?php 
	...
	$fetchPage     = new impPage\Pagination();
		 ...
		 $alladvocate = $fetchAdvocate->singleSrAdvocatesOnPannel($_GET['advocateId']);	
			...
			<div id="right-wrapper">
				...
				?>
	     		...
	     		<div class="title1" style="height:20px;">
     				<div id="left-title">Advocate Appointmented Applications</div>
	  		...
	  		<div class="clear"></div>	
	     			<div style="border:2px solid #4b8df8;padding:7px;">
		     			<table id="table-records" cellpadding="0px" cellspacing="0px" width="100%">
                            ...
                            <td><?php if ($alladvocate[$i]['appointment_date']!='') echo date("d-m-Y", strtotime($alladvocate[$i]['appointment_date'])); ?></td>
                            <td><?php echo $alladvocate[$i]['diary_no']; ?></td>
	     				</tr>    						
