	     			...
	     			<form name="editDocument" id="editDocument" method="POST">
		     				...
		     				<table id="table-records" cellpadding="0px" cellspacing="0px" width="100%">
			     				...
			     				<?php
			     					...
			     					for($i =0;$i<count($docRequestType);$i++)
			     					{
			     						$temp = $docRequestType[$i]['appli_type_name'];
			     						if($docRequestType[$i++]['appli_type_name']==$temp)
			     							$counter++;
			     					...
			     					/* for($i =0;$i<count($docRequestType);$i++)
									{
										$appliName = $docRequestType[$i]['appli_type_name'];
										$doc = $docRequestType[$i]['doc_name'];
										if($docRequestType[$i]['appli_type_name'] == $appliName)
										{
											$counter++;
											$doc .= $docRequestType[$i]['doc_name'];
								...
								?>
				     				<tr class="<?php echo $class; ?>">
				     					<td><?php echo $i+1; ?></td>
				     					<td><?php echo $docRequestType[$i]['appli_type_name'];?></td>
				     					<td><?php echo $docRequestType[$i]['doc_name'];?></td>
				     					<td><a href="edit_docs_in_appli_type.php?appliId=<?php echo $docRequestType[$i]['request_type_id']; ?>&action=edit">Edit</a>				     			
					     				</td>
					     				<td>
					     				<a href="#">Delete</a>
					     				</td>
