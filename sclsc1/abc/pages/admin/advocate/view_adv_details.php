<?php 
	...
	$fetchAdvocate = new impAdvocate\Fetch();
	 ...
	 $advDetails     = $fetchAdvocate->singleAvocateDetails($_GET['advocateId']);
	 $periodDetails  = $fetchAdvocate->avocatePeriod($_GET['advocateId']);
	//print_r($advDetails);
	...
	<div class="clear"></div> 
	     	<div class=".container">
		     		 ...
		     		 ?> 
								...
								<?php if (isset($advDetails[1]['is_commun_address']) && $advDetails[1]['is_commun_address']==TRUE && $advDetails[1]['is_commun_address']!='') { ?>
									<div class="clear"></div>
									<div class="clear"></div>
