<?php 
	...
	if(isset($_GET['page']))
	{
		...
		if($page){
		 ...
		 $alladvocate = $fetchAdvocate->getAdvocatesOnPannel($limit,$start);	
		 $Records = $fetchAdvocate->getAdvocatesOnPannelCount();
		 $url='';
			...
			<div id="right-wrapper">
				...
				?>
	     		...
	     		<div class="title1" style="height:20px;">
     				<div id="left-title">Appointmented Advocate List</div>
