<?php 
	...
	$targetpage = 'docSendDispatch.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="srAdvConsultation.php">Senior Advocate Consultation &nbsp;&nbsp;&nbsp;</a>/</li>
	     				<li><a href="#">Applications Document Reminder Generated</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					{
				     					?>				     								     					
				     					 <a href="generateLetter.php?application_id=<?php echo $diary[$i]['id'] ?>">Re-Generate Letter</a>
				     					 <?php } ?>
				     					</td>				     				
				     				</tr>     						
