	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">	     			
	     		    <ul>
	     				...
	     				<li><a href="#">Generate letter to get the signed the affidavit for filing from applicant</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href = "generateTranslatorLetter.php?application_id=<?php echo $diary[$i]['id'] ?>">Action </a></td>				     				
				     				</tr>			     					
		     			     	<?php 
									}									
									 echo $pagination;
