<?php 
	...
	$targetpage = 'primaFacieDecision.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
...
<html lang="en">
	<head>
		...
		function primaFacieFitAction(str)
		{ 	
		...
		xmlhttp.open("GET","primaFacieFitAction.php?q="+str,true);
		xmlhttp.send();
		}	
		</script>
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="#">>Case Filed in SCI Decision</a></li>
	     			</ul>
	     		</div>
	     	...
	     	<div class="clear"></div>
	     		...
	     		<div id="breadcrumb">
	     			...
	     			<div style="border:2px solid #4b8df8;padding:7px">
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href = "javascript:void(0)" onclick = "primaFacieFitAction(<?php echo $diary[$i]['id'] ?>)">Action</a></td>				     				
				     				</tr>
		     				...
		     				<div id="light" class="white_content" style="width:32%;height:30%"></div>
