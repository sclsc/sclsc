			...
			<div id="right-wrapper">
	     	   ...
	     	   <div id="breadcrumb-green">
	     		...
	     		<div class="clear"></div>
	     			...
	     			<!-- 	<div id="right-title" style="text-align: right;width:300px;float:right;align:middle;"><input type="text" placeholder="Enter Diary Number" name="application_search" id="application_search" value=""/></div> -->
	     			</div>
		     				...
		     				<table id="table-records" cellpadding="0px" cellspacing="0px" width="100%">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td><a href="<?php echo $applications[$i]['stage_page']; ?>?application_id=<?php echo $applications[$i]['id'] ?>"> Current Stage </a></td>
