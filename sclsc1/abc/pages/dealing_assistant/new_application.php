 ...
 */	$msg = '';
	...
	$addDiary = new impDairy\Add();
	$editDiary = new impDairy\Edit();
	...
	if(isset($_POST['submit']))
	{
		...
		$recievedDate       = 	trim($_POST['received_date']);
		$recievedThrough    =	(int) trim($_POST['received_through']);
		...
		$appId = $addDiary->registerDiaryByDeelingAssistant(
				$diaryNo,
				$recievedDate,
				$recievedThrough,
				$applicationType
		...
		$statusFlag = $editDiary->UpdateDiaryStatus($_GET['id']);
		
		$url = 'success_stage.php?id='.$appId;
		$msg = 'Secand Stage Completed Successfully';
	...
	$applicationTypes = $fetchAppType->getAllApplicationType(NULL,NULL);
	    ...
	    <div class="wrapper" >
			...
			<div id="right-wrapper">
				<div id="breadcrumb">
	     		...
	     		<form action="new_application.php?id=<?php echo $_GET['id']?>" method="post" onsubmit="return validateDiary()" name="diary">
					...
					<h3>Legal Aid Sought for</h3>
						<div style="width:80%;margin-left:1%">
								...
								<div class="left">
										...
										<div class="left"> Application Type </div>
										<div class="right">
