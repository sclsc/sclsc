...
$applicationTranslator = $fetchCof->getApplicationTranslator($applicationId);
$translatorId =	$applicationTranslator[0]['translator_id'];
$translatorName =	$applicationTranslator[0]['translator_name'];
			...
			<div id="right-wrapper">
				<div id="breadcrumb">
	     			<ul>
	     				...
	     				<li><a href="translatorLetter.php">Letter generation for Translation &nbsp;&nbsp;&nbsp;&nbsp;</a>/</li>
	     				<li><a href="#">Generate Translator Letter</a></li>
	     			</ul>
	     		</div>
	     		<div class="clear"></div>
	     		<?php if($msg != '')
	     					...
	     					<div style="width:80%;margin-left:1%">
								...
								<div class="right">
										...
										<div class="right">
											...
											<input type="hidden" id="to"  name="to[]" value="<?php echo $translatorId; ?>"/>
											&nbsp;&nbsp;<?php echo 1; ?>&nbsp;)&nbsp; -> <?php echo $translatorName;?><br/>
