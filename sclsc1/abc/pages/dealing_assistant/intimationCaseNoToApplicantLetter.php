<?php 
	...
	$targetpage = 'intimationCaseNoToApplicantLetter.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="#">Letter generation for Intimation of Case no. to applicants</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href = "generateLetter.php=application_id<?php echo $diary[$i]['id'] ?>)">Action </a></td>				     				
				     				</tr>			     					
		     			     	<?php 
									}									
									 echo $pagination;
