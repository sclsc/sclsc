	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="fitForFiling.php">Fit for Filing &nbsp;&nbsp;&nbsp;</a>/</li>
	     				<li><a href="#">Fit for Filing Reminder Generated</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					{
				     					?>				     								     					
				     					 <a href="reGenerateOpinionLetter.php?application_id=<?php echo $diary[$i]['id'] ?>">Re-Generate Letter</a>
				     					 <?php } ?>
				     					</td>				     				
				     				</tr>     						
