<?php 
	...
	$targetpage = 'caseFiledSciSendDispatch.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     			    ...
	     			    <li><a href="caseFiledSci.php">Case to be Filed in SCI &nbsp;&nbsp;&nbsp;&nbsp;</a>/</li>
	     				<li><a href="#">Case Filed in SCI Send To Dispatch</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href="caseFiledSciSendDispatch.php?applicationId=<?php echo $diary[$i]['id'] ?>&action=up">Send  For Dispatch </a></td>				     				
				     				</tr>
