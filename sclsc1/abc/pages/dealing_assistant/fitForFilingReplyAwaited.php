	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">	     			
	     		    <ul>
	     				...
	     				<li><a href="#">Applications Fit for Filing Reply Awaited</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					?>
				     					<a href="fitForFilingReplyAwaited.php?applicationId=<?php echo $diary[$i]['id'] ?>&action=up"  onclick="return confirm('Are you sure you want to go to Secand Opinion?')">Second Opinion</a>
				     					<?php
				     					}
				     					else 
				     					{
