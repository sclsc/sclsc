	     		...
	     		<div id="breadcrumb">
	     			...
	     			<div style="border:2px solid #4b8df8;padding:7px">
		     				<table id="table-records" cellpadding="0px" cellspacing="0px" width="100%">
			     				<tr width="100%">			     						
			     				<th width="13%"><a href="advAppoinmentApplication.php">Appoinment Advocate</a></th>	  
			     				<th width="10%"><a href="advLetter.php">Generate Letter</a></th>   					
			     					<th width="10%"><a href="advSendDispatch.php">Send for Dispatch</a></th>
			     					<th width="10%"><a href="advToBeDispatched.php">To be Dispatched</a></th>
			     					<th width="10%"><a href="advReplyAwaited.php">Reply Awaited</a></th>
