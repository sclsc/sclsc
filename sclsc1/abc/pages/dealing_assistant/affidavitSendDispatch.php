<?php 
	...
	$targetpage = 'affidavitSendDispatch.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="#">Affidavit Send To Dispatch</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href="affidavitSendDispatch.php?applicationId=<?php echo $diary[$i]['id'] ?>&action=up">Send  For Dispatch </a></td>				     				
				     				</tr>
