<?php 
	...
	$targetpage = 'intimationCaseToApplicantSendDispatch.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">	     			
	     		    <ul>
	     				...
	     				<li><a href="intimationCaseNoToApplicant.php">Intimation of Case no. to applicants &nbsp;&nbsp;&nbsp;</a>/</li>
	     				<li><a href="#"> Send To Dispatch</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
			                    ...
			                    $city='';
			     				...
			     				$pincode='';
	     							...
	     							for($i =0;$i<count($diary);$i++)
									{
										...
										$letterStatus = $fetchCof->letterReminderStatus($diary[$i]['id'], $stageId);
										//	print_r($letterStatus);		
                                       $letter_no = $letterStatus[$i]['letter_no'];
                                       $parent_letter_no = $letterStatus[$i]['parent_letter_no'];
                                       $dispatch_date = $letterStatus[$i]['dispatch_date'];
                                       $reminder_status = $letterStatus[$i]['reminder_status'];
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td><?php echo $letter_no; ?></td>
				     					<td><?php echo $status ?></td>
				     					<td> <a href="intimationCaseToApplicantSendDispatch.php?applicationId=<?php echo $diary[$i]['id'] ?>&action=up">Send  For Dispatch </a></td>				     				
				     				</tr>
