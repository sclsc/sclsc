...
/*	$targetpage = 'addDocument.php';
	...
	*/
	...
	//	print_r($requestType);
		...
		//$applicants = $fetchAppli->getApplicants($_GET['id']);
	       ...
	       <?php } ?>
	     			...
	     			<div style="border:2px solid #4b8df8;padding:7px;">
	     				<table id="table-records" cellpadding="0px" cellspacing="0px" width="100%">
								...
								{								
								$docType = $fetchDoc->getAllmatchingData($requestType[$i]['appli_type_id']);
							//	echo $requestType[$i]['id'];
								 $appliDocType = $fetchAppli->applicantionDocCount($requestType[$i]['id']);
     						...
     						<td><?php echo $requestType[$i]['diary_no'];?></td>
                            <td><?php echo $requestType[$i]['appli_type_name'];?></td>
				     		...
				     		<td>
				     		<?php if ($appliDocType == 0) { ?>
				     		<a href="applicant_doc.php?appliId=<?php echo $requestType[$i]['id']; ?>">Add New Doc</a> 
				     		<?php } else { ?>
				     		<a href="applicant_completed_doc.php?appliId=<?php echo $requestType[$i]['id']; ?>">View / Edit Completed Doc</a>	
				     		<?php } ?>			     			
					     	</td>
     					</tr>
	     				<?php 
