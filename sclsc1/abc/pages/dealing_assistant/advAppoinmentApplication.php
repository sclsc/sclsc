<?php 
	...
	$targetpage = 'advAppoinmentApplication.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="#">Advocate Appoinmented List</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href="addAdvAppoinment.php?application_id=<?php echo $diary[$i]['id'] ?>&appliNo=<?php echo $diary[$i]['diary_no'] ?>">Appoinment</a></td>				     				
				     				</tr>
