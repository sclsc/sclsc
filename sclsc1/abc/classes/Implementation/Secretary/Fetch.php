<?php
	namespace classes\Implementation\Secretary;
	
	require_once $_SESSION['base_url'].'/classes/Connection/Connection.php';
	require_once $_SESSION['base_url'].'/classes/Interfaces/Secretary/Fetchable.php';
	
	use classes\Connection as Conn;
	use classes\Interfaces\Secretary as IFetch;
