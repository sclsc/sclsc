<?php
	...
	require_once $_SESSION['base_url'].'/classes/Interfaces/Advocate/Editable.php';
	
	use classes\Connection as Conn;
	use classes\Interfaces\Advocate as IEdit;
	 
	class Edit implements IEdit\Editable
	{
		
		/*public function upAvocateStatus($advocateId,$fullname,$gender,$lang,$email_id,$mobile_no,$mobile_no2,$date_of_reg,
										$date_of_enrol,$name_of_bar,$date_of_scba,$aor,$advocate_code,
										$is_on_panel,$is_aor,$address1,$address2,$city,$state,$pincode,$comm_add,$c_name,
										$c_address1,$c_address2,$c_city,$c_state,$c_pincode)*/
		public function upAvocateStatus($advocateId,$fullname,$gender,$lang,$email_id,$mobile_no,$mobile_no2,
				$date_of_enrol,$name_of_bar,$date_of_scba,$aor,$advocate_code,
		...
		{   
		 ...
		 try 
		  {			
			...
			$query = "UPDATE tbl_advocates SET advocate_name=:fullname,gender=:gender,language=:lang,email_id=:email_id,contact_no1=:mobile_no,contact_no2=:mobile_no2,
					advocate_enrol_date=:date_of_enrol,enrolled_bar=:name_of_bar,scba_enrol_date=:date_of_scba,
					aor_desig_date=:aor,advocate_code=:advocate_code,is_on_panel=:is_on_panel,is_aor=:is_aor WHERE id = :advocateId";
		...
		//	$statement->bindParam(':title', $title, \PDO::PARAM_STR);
			...
			//$comm_add_1='f';
			$sqladd = "UPDATE tbl_adv_address SET address1=:address1,address2=:address2,city=:city,state=:state,pincode=:pincode
					 WHERE advocates_id = :advocateId AND is_commun_address IS FALSE";
			...
			$sqlcomm = "UPDATE tbl_adv_address SET address1=:c_address1,address2=:c_address2,city=:c_city,state=:c_state,pincode=:c_pincode,commun_name=:c_name
					 WHERE advocates_id = :advocateId AND is_commun_address IS TRUE";
			...
			$query = "delete from tbl_advocate_period WHERE advocates_id = :advocateId";
			...
			$is_active="t";
			$periodReg = "insert into tbl_advocate_period(advocates_id,start_date,is_active)
			...
			{
			$is_active='f';
			$sqlperiod = "insert into tbl_advocate_period(advocates_id,start_date,end_date,is_active)
