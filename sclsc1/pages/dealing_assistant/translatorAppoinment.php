	     		...
	     		<div id="breadcrumb">
	     			...
	     			<div style="border:2px solid #4b8df8;padding:7px">
		     				<table id="table-records" cellpadding="0px" cellspacing="0px" width="100%">
			     				<tr width="100%">			     						
			     				<th width="13%"><a href="translatorAppoinmentApplication.php">Translator Appoinment</a></th>	  
			     				<th width="10%"><a href="translatorLetter.php">Generate Letter</a></th>   					
			     				<th width="10%"><a href="translatorSendDispatch.php">Send for Dispatch</a></th>
			     				<th width="10%"><a href="translationToBeDispatched.php">To be Dispatched</a></th>
			     				<th width="10%"><a href="translationReplyAwaited.php">Reply Awaited</a></th>
			     				<th width="10%"><a href="translationReminderGenerated.php">Reminder to be Generated</a></th>			     						     							     					
			     				</tr>
