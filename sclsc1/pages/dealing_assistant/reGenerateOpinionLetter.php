...
$errmsg = '';
	...
	$allList = $fetchAdvocate->getSrAdvocatesList();
			...
			<div id="right-wrapper">
				<div id="breadcrumb">
	     		...
	     		<div class="title1" style="height:20px;">
     				<div id="left-title">Re-Generate Letter</div>
								...
								<div class="right">
										...
										<select name="letterType" id="letterType" onchange="change_letter_type(this.value);">
				     						...
				     						for($i =0;$i<count($letterTypes);$i++)
												{
												?>
				     								<option value="<?php echo $letterTypes[$i]['id']; ?>" ><?php echo $letterTypes[$i]['letter_type_name']; ?></option>
				     							<?php 
												}
				     						?>
				     						</select>											
										...
										<div class="right">
									<select name="to" id="to" multiple style="height:30%" required="required">				     							
				     						<?php
				     						for($i =0;$i<count($allList);$i++)
												{
											?>
				     							<option value="<?php echo $allList[$i]['id']; ?>"><?php echo $allList[$i]['sr_advocate_name']; ?></option>
				     						<?php 
												}
				     						?>
				     						</select>
