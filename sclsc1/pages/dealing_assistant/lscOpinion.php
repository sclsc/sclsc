	     		...
	     		<div id="breadcrumb">
	     			...
	     			<div style="border:2px solid #4b8df8;padding:7px">
		     				<table id="table-records" cellpadding="0px" cellspacing="0px" width="100%">
			     				<tr width="100%">			     					
			     					<th width="10%"><a href="lscOpinionLetter.php">Letter to be generated opinion</a></th>
			     					<th width="10%"><a href="lscOpinionSendDispatch.php">Send for dispatch (opinion to LSC) </a></th>			     					
			     					<th width="10%"><a href="lscOpinionToBeDispatched.php">Dispatched (LSC)</a></th>
			     					<th width="10%"><a href="lscOpinionReplyAwaited.php">Reply Awaited</a></th>		
			     					<th width="10%"><a href="lscOpinionReminderGenerated.php">Reminder to be Generated</a></th>		     						     							     					
			     				</tr>
