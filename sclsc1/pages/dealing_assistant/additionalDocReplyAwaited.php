...
/*	
	...
	*/
	...
	$targetpage = 'additionalDocReplyAwaited.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="#">Applications Additional Document Reply Awaited</a></li>
	     			</ul>
	     		</div>
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					?>
				     					 ...
				     					 <a href="applicant_completed_doc.php?appliId=<?php echo $diary[$i]['id'] ?>">Add Document</a>
				     					 <?php } ?>
				     					</td>				     				
				     				</tr>     						
