<?php 
	...
	$targetpage = 'intimationApplicantSendDispatch.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">	     			
	     		    <ul>
	     				...
	     				<li><a href="intimationToApplicant.php">Intimation to applicant about granting of Legal Aid &nbsp;&nbsp;&nbsp;</a>/</li>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href="srAdvSendDispatch.php?applicationId=<?php echo $diary[$i]['id'] ?>&action=up">Send  For Dispatch </a></td>				     				
				     				</tr>
