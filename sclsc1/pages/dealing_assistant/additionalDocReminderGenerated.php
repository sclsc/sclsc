...
*/	
	$targetpage = 'additionalDocReminderGenerated.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	...
	$stageId=43;
	$subStageId=47;
	$diary = $fetchCof->getApplicationReminderDoc($stageId, $subStageId, $limit, $start);
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="additionalDoc.php">Additional Document Completion &nbsp;&nbsp;&nbsp;&nbsp;</a>/</li>
	     				<li><a href="#">Additional Document Reminder Generated</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
			                    ...
			                    $city='';
			     				...
			     				$pincode='';
									...
									{
									 	$applicationDoc          =  $fetchDiary->applicantionDocCount($diary[$i]['id']);
									    $allApplicants           = $fetchCof->getApplicats($diary[$i]['id']);
									    $applicantsCount         = count($allApplicants);
									    $applicationCompletedDoc = $applicantsCount*$applicationDoc;
									     
									    $application = $fetchCof->getApplicationDetails($diary[$i]['id']);									    									      
									    $allApplicationDocId = $fetchDoc->getSingleDocRequest($application[0]['appli_type_id']);
									    
									    $allApplicationDoc   = count($allApplicationDocId);
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td>
				     					<?php 
				     					if($allApplicationDoc ==$applicationCompletedDoc)
				     					{
				     					...
				     					{
				     					?>				     								     					
				     					 <a href="generateAdditionalDocLetter.php?application_id=<?php echo $diary[$i]['id'] ?>">Re-Generate Letter</a>
				     					 <?php } ?>
				     					</td>				     				
				     				</tr>     						
