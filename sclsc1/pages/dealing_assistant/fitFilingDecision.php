...
<html lang="en">
	<head>
		...
		function fitForFilingAction(str)
		{ 	
		...
		xmlhttp.open("GET","fitForFilingAction.php?q="+str,true);
		xmlhttp.send();
		}	
		</script>
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="#">Fit for Filing Decision</a></li>
	     			</ul>
	     		</div>
	     	...
	     	<div class="clear"></div>
	     		...
	     		<div id="breadcrumb">
	     			...
	     			<div style="border:2px solid #4b8df8;padding:7px">
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href = "javascript:void(0)" onclick = "fitForFilingAction(<?php echo $diary[$i]['id'] ?>)">Action</a></td>				     				
				     				</tr>
		     				...
		     				<div id="light" class="white_content" style="width:35%;height:30%"></div>
