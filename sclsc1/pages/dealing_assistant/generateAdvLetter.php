...
$applicationAdvocate = $fetchCof->getApplicationAdvocate($applicationId);
$advocateId        =	$applicationAdvocate[0]['id'];
$advocateName      =	$applicationAdvocate[0]['advocate_name'];
			...
			<div id="right-wrapper">
				<div id="breadcrumb">
	     			<ul>
	     				...
	     				<li><a href="#">Generate Advocate Letter</a></li>
	     			</ul>
	     		</div>
	     		<div class="clear"></div>
	     		<?php if($msg != '')
	     					...
	     					<div style="width:80%;margin-left:1%">
								...
								<div class="right">
										...
										<div class="right">
											...
											<input type="hidden" id="to"  name="to[]" value="<?php echo $advocateId; ?>"/>
											&nbsp;&nbsp;<?php echo 1; ?>&nbsp;)&nbsp; -> <?php echo $advocateName;?><br/>
