<?php 
	...
	$targetpage = 'lscOpenionSendDispatch.php';
	$adjacents = 2;
	$limit = 10;
	$start = 0;
	$page = 0;
	    ...
	    <div class="wrapper" >
			...
			<div id="breadcrumb">
	     		    ...
	     		    <ul>
	     				...
	     				<li><a href="#">LSC Opinion Send To Dispatch</a></li>
	     			</ul>
	     		</div>
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href="lscOpinionSendDispatch.php?applicationId=<?php echo $diary[$i]['id'] ?>&action=up">Send  For Dispatch </a></td>				     				
				     				</tr>
