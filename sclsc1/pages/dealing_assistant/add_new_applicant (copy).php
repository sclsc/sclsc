<?php 
	...
	require_once '../../classes/Implementation/Diary/Edit.php';
	require_once '../../classes/Implementation/State/Fetch.php';
	require_once '../../classes/Implementation/Eligibility/Fetch.php';
	...
	$fetchEligibility = new impEligibility\Fetch();
		...
		{
			$statusFlag = $editDiary->UpdateDiaryStatus($fetchDiary->getApplicationId($_GET['id']));
...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			 ...
			 $.ajax({
			 type: "POST",
			 url: "ageCalculation.php?dob="+$('#dob').val(),
	     		...
	     		<div class="title1" style="height:20px;">
							...
							<h3>Applicant Details</h3>
	     					<div style="width:80%;margin-left:1%">
								...
								<div class="left">
										...
										<div class="right">
											<input type="text" id="age" placeholder=" Applicant Age" onblur="myFunction()" name="age" value="<?php ?>" />
										</div>
										<div class="clear"></div>
					...
					<div class="clear"></div>
						...
						<table id="table-records" cellpadding="0px" cellspacing="0px" width="100%">
			     		...
			     		<form action="add_new_applicant.php"; method="post" >	
							<div style="text-align:center;padding:10px 0;">
								<input class="form-button" type="submit" name="saveApplicant" value="Save" />
							</div>
						</form>
						<div class="clear"></div>
						<div class="clear"></div>
