			...
			<div id="right-wrapper">
	  		...
	  		<div class="clear"></div>	
                  ...
                  <td><a href="index.php?advocateId=<?php //echo $alladvocate[$i]['id']; ?>&activeStatus=<?php // echo $activeStatus; ?>&action=up"><?php echo $status; ?></a></td> --> 
                            <td><a href="translator_registration.php?translatorId=<?php echo $alltranslator[$i]['translator_id']; ?>&action=edit">Edit</a></td>
                            <td><a href="index.php?translatorId=<?php echo $alltranslator[$i]['translator_id']; ?>&action=del">Delete</a></td>
	     				</tr>    						
