	...
	<head>
		...
		$(document).ready(function(){
			...
			$('#registrationdate').keyup(function(){		
				...
				$.ajax({
					    type: "POST",
					    url: "ajax/searchadvocate.php?reg_date="+$('#registrationdate').val(),
		...
		$diff = $end - $begin;
	 	...
	 	if($days>=730)
	 	{
							...
							?>
	     					...
	     					<td><?php echo $i+1; ?></td>	     					
	     					 <td><a href="view_adv_details.php?advocateId=<?php echo $alladvocates[$i]['advocate_id']; ?>"><?php echo $alladvocates[$i]['advocate_name']; ?></a></td>
