		 ...
		 {	
			...
			$document = 'sample.odt';
			 ...
			 //	$content_xml = str_replace($replace_from, $replace_to, $ODT['content_xml']);
			 	$source = file_get_contents($dataFile);
			 	$source = str_replace('#firstname','XXXplaceholder1XXX', $source);
			 	$source = str_replace('#lastname','XXXplaceholder2XXX', $source);echo $source; die;
			 	file_put_contents($dataFile, $source);
			...
			<div id="right-wrapper">
	           ...
	           <div style="height:auto;border:1px solid #4b8df8;">
	            ...
	            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" name="letter_type" id="letter_type" method="post" onsubmit="return validateLetterType()">
						...
						<input type="hidden" id="application_id" name="application_id" value="<?php echo $_POST['application_id'];?>"/>	
					   <input type="hidden" id="slpAction" name="slpAction" value="<?php echo $_POST['slpAction'];?>"/>					
