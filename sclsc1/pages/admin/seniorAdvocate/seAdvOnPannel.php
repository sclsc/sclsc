<?php 
	...
	if(isset($_GET['page']))
	{
		...
		if($page){
		 ...
		 $alladvocate = $fetchSrAdvocate->getSrAdvocatesOnPannel($limit,$start);		
		 $Records = $fetchSrAdvocate->getSrAdvocatesOnPannelCount();
		 $url='';
			...
			<div id="right-wrapper">
				...
				?>
	     		...
	     		<div class="title1" style="height:20px;">
     				<div id="left-title">Appointmented Senior Advocate List</div>
