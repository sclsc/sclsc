...
//	$Records = $fetchCof->getMISCApplicationCount($stageId, $subStageId);
	$diary = $fetchCof->getDispatchApplications($limit, $start);
	$Records = $fetchCof->getDispatchApplicationsCount();
	$url ='';
		     				...
		     				<table id="table-records">
								...
								?>
				     				<tr class="<?php echo $class; ?>" align="center">
				     					...
				     					<td> <a href = "dispatchAddressee.php?applicationId=<?php echo $diary[$i]['id'] ?>">Dispatch Addressee</a></td>				     				
				     				</tr>
