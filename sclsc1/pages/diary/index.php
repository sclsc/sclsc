	     		...
	     		<div id="form">
		     			...
		     			<div style="border:1px solid #4b8df8;background-color:#fff;height:660px;padding:8px 0px">
			     			...
			     			<div style="width:50%;float:left;">
			     				...
			     				<div class="right"><input placeholder="dd-mm-yyyy" required="required" type="text" id="recieved_date" name="recievedDate" value="<?php echo date('d-m-Y'); ?>" size="10" maxlength="10" required="required" /></div>
			     				<div class="clear"></div>
			     			</div>
			     			<div style="width:50%;float:right;">
			     				<div class="clear"></div>
			     				<div class="left"> 	Letter Reference No. </div>
			     				<div class="right"><input type="text" id="letter_no" name="letterNo" placeholder="Letter Number" /></div>
			     				<div class="clear"></div>
			     				
			     				<div class="left"> Letter Date *</div>
			     				<div class="right"><input required="required" type="text" name="letterDate" id="letter_date" size="10" maxlength="10" required="required" placeholder="dd-mm-yyyy" /></div>
		     					<div class="clear"></div>
		     				...
		     				<div style="width:50%;float:left;">
			     				...
			     				<div class="right"><input required="required" type="text" name="sender" placeholder="Name" id="applicant_name" /></div>
		     					<div class="clear"></div>
								...
								<div class="right">
			     				...
			     				<div class="right"><input type="text" name="mailId" placeholder="Email ID" id="applicant_mail_id" /></div>
			     				<div class="clear"></div>
			     				<div class="left"> Contact No</div>
			     				<div class="right"><input type="text" name="contactNumber" id="contact_number"  placeholder="Contact Number" maxlength="14" size="14" /></div>
			     				<div class="clear"></div>
			     			...
			     			<div style="width:50%;float:right;">
		     					...
		     					<div class="right"><input required="required" type="text" name="address1" id="address1" placeholder="Address1" /></div>
		     					<div class="clear"></div>
		     					<div class="left"></div>
		     					<div class="right"><input type="text" name="address2" placeholder="Address2" id="address2" /></div>
		     					<div class="clear"></div>
		     					<div class="left"> Village/City/District *</div>
		     					<div class="right"><input required="required" id="applicant_city" type="text" name="city" placeholder="Village / City / District" /></div>
			     				<div class="clear"></div>
		     					...
		     					<div class="right"><input type="text" id="applicant_pincode" name="pincode" placeholder="XXXXXX" /></div>
		     				</div>
		     				<div class="clear"></div>
		     				<h3>Subject</h3>
		     				<div style="width:82%;margin-left:18%">
	     						...
	     						<div style="float:right;width:91%">
	     							<input required="required" type="text" id="subject" name="subject" placeholder=" Enter Subject" />
	     						</div>
		     					<div class="clear"></div>
	     						...
	     						<div style="float:left;width:50%;padding-left:3%">
	     							<select name="mark_to" required="required" id="mark_to" >
										...
										{
										?>
										<option value="<?php echo $dealingUsers[$i]['id']; ?>"><?php echo $dealingUsers[$i]['user_name']; ?></option>
										<?php 
										}
										?>
									</select>
	     						</div>
	     						<div style="margin-left:15%;padding-top:20px;"><div class="clear"></div><input type="submit" name="submit" value="Add Diary" class="form-button" />
	     						</div>
	     						</div>
		     				</div>
		     			</div>
