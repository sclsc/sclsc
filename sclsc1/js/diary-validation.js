	...
	{		
		...
		var diary_no = document.getElementById('diary_no').value;
		var received_date = document.getElementById('recieved_date').value;
		...
		var mark_to = document.getElementById('mark_to').value;
		...
		if(diary_no == '')
		{
			...
			document.getElementById('diary_no').focus();
			return false;
		}
		if(diary_no != '' && diary_no.length > 20)
		{
		...
		if(letter_no != '' && letter_no.length > 20)
		{
			alert("Invalid Letter Number");
		...
		if(received_date != ''&& received_date.length != 10)
		{
			alert("Invalid RecIeved Date");
			document.getElementById('received_date').focus();
			return false;
		}
		...
		if(letter_date != '' && letter_date.length != 10)
		{
			alert("Invalid Leter Date");
			document.getElementById('letter_date').focus();
			return false;
		}
		...
		if(applicant_name != '' && applicant_name.length > 20)
		{
			alert("Invalid Applicant Name");
			document.getElementById('applicant_name').focus();
			return false;
		}
		if(address1 != '' && address.length > 20)
		{
			alert("Invalid Applicant Name");
			document.getElementById('applicant_name').focus();
			return false;
		 ...
		 if(contact_number != '')
		 {
			 ...
			 if (contact_number.length >14)
			 {
				 alert("Length of Contact Number must be less than 14 digits.");
				 document.getElementById('contact_number').focus();
				 return false;
			 }
		 }
